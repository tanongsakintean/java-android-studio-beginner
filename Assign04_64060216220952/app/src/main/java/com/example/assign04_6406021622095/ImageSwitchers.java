...
public class ImageSwitchers extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_switchers);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btnNext) {
            if (mPosition < IMAGES.length-1) {
                ...
                Toast.makeText(ImageSwitchers.this, "Position : "+ mPosition,
